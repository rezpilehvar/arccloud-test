...
public class LayoutHelper {
    ...
    private static int getSize(float size) {
        return (int) (size < 0 ? size : DisplayUtility.dp(size));
    }
    ...
    public static ScrollView.LayoutParams createScroll(int width, int height, int gravity, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        ...
        layoutParams.leftMargin = DisplayUtility.dp(leftMargin);
        layoutParams.topMargin = DisplayUtility.dp(topMargin);
        layoutParams.rightMargin = DisplayUtility.dp(rightMargin);
        layoutParams.bottomMargin = DisplayUtility.dp(bottomMargin);
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrame(int width, float height, int gravity, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        ...
        layoutParams.setMargins(DisplayUtility.dp(leftMargin), DisplayUtility.dp(topMargin), DisplayUtility.dp(rightMargin), DisplayUtility.dp(bottomMargin));
        return layoutParams;
    }

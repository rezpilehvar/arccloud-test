...
import com.ronaksoftware.musicchi.ui.components.AnimationProperties;
...
public class BottomSheet extends Dialog {
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        private void checkDismiss(float velX, float velY) {
            ...
            boolean backAnimation = translationY < DisplayUtility.getPixelsInCM(0.8f, false) && (velY < 3500 || Math.abs(velY) < Math.abs(velX)) || velY < 0 && Math.abs(velY) >= 3500;
            if (!backAnimation) {
                ...
                currentAnimation.setDuration((int) (150 * (translationY / DisplayUtility.getPixelsInCM(0.8f, false))));
            ...
            if (containerView != null) {
                if (!fullWidth) {
                    ...
                    if (DisplayUtility.isTablet()) {
                        widthSpec = MeasureSpec.makeMeasureSpec((int) (Math.min(DisplayUtility.displaySize.x, DisplayUtility.displaySize.y) * 0.8f) + backgroundPaddingLeft * 2, MeasureSpec.EXACTLY);
                    } else {
                        widthSpec = MeasureSpec.makeMeasureSpec(isPortrait ? width + backgroundPaddingLeft * 2 : (int) Math.max(width * 0.8f, Math.min(DisplayUtility.dp(480), width)) + backgroundPaddingLeft * 2, MeasureSpec.EXACTLY);
                    }
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            if (layoutCount == 0 && startAnimationRunnable != null) {
                Queues.cancelRunOnUIThread(startAnimationRunnable);
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            //setPadding(DisplayUtility.dp(16), 0, DisplayUtility.dp(16), 0);
        ...
        public void setTextAndIcon(CharSequence text, int icon, boolean bigTitle) {
            ...
            if (icon != 0) {
                ...
                if (bigTitle) {
                    textView.setPadding(DisplayUtility.dp(LocaleController.isRTL ? 21 : 72), 0, DisplayUtility.dp(LocaleController.isRTL ? 72 : 21), 0);
                    imageView.setPadding(LocaleController.isRTL ? 0 : DisplayUtility.dp(5), 0, LocaleController.isRTL ? DisplayUtility.dp(5) : 5, 0);
                } else {
                    textView.setPadding(DisplayUtility.dp(LocaleController.isRTL ? 16 : 72), 0, DisplayUtility.dp(LocaleController.isRTL ? 72 : 16), 0);
                    imageView.setPadding(0, 0, 0, 0);
                }
            } else {
                imageView.setVisibility(INVISIBLE);
                textView.setPadding(DisplayUtility.dp(bigTitle ? 21 : 16), 0, DisplayUtility.dp(bigTitle ? 21 : 16), 0);
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setWindowAnimations(R.style.Theme_MusicChi_DialogNoAnimation);
        ...
        if (containerView == null) {
            ...
            containerView.setPadding(backgroundPaddingLeft, (applyTopPadding ? DisplayUtility.dp(8) : 0) + backgroundPaddingTop - 1, backgroundPaddingLeft, (applyBottomPadding ? DisplayUtility.dp(8) : 0));
        }
        ...
        if (title != null) {
            ...
            if (bigTitle) {
                ...
                titleView.setTypeface(TypefaceUtility.getTypeface("fonts/rmedium.ttf"));
                titleView.setPadding(DisplayUtility.dp(21), DisplayUtility.dp(6), DisplayUtility.dp(21), DisplayUtility.dp(8));
            } else {
                titleView.setTextColor(Theme.getColor(Theme.key_dialogTextGray2));
                titleView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
                titleView.setPadding(DisplayUtility.dp(16), 0, DisplayUtility.dp(16), DisplayUtility.dp(8));
            }
    ...
    public void show() {
        ...
        containerView.measure(View.MeasureSpec.makeMeasureSpec(DisplayUtility.displaySize.x + backgroundPaddingLeft * 2, View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(DisplayUtility.displaySize.y, View.MeasureSpec.AT_MOST));
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            Queues.runOnUIThread(startAnimationRunnable = new Runnable() {
                @Override
                public void run() {
    ...
    public void dismissWithButtonClick(final int item) {
        ...
        currentSheetAnimation = new AnimatorSet();
        currentSheetAnimation.playTogether(
                ObjectAnimator.ofFloat(containerView, "translationY", containerView.getMeasuredHeight() + DisplayUtility.dp(10)),

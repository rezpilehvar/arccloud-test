...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItem(int id, Drawable drawable) {
        return addItem(id, 0, null, isActionMode ? parentActionBar.itemsActionModeBackgroundColor : parentActionBar.itemsBackgroundColor, drawable, DisplayUtility.dp(48), null);
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, int backgroundColor) {
        return addItem(id, icon, null, backgroundColor, null, DisplayUtility.dp(48), null);
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, CharSequence text, int backgroundColor, Drawable drawable, int width, CharSequence title) {
        ...
        if (text != null) {
            ...
            LayoutParams layoutParams = new LayoutParams(width != 0 ? width : ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
            layoutParams.leftMargin = layoutParams.rightMargin = DisplayUtility.dp(14);
            ...
            addView(menuItem, new LayoutParams(width, ViewGroup.LayoutParams.MATCH_PARENT));
        }

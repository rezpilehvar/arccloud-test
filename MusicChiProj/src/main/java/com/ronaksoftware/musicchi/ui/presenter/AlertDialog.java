...
import com.ronaksoftware.musicchi.ui.components.LineProgressView;
import com.ronaksoftware.musicchi.ui.components.RadialProgressView;
...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context) {
            ...
            setPadding(DisplayUtility.dp(23), 0, DisplayUtility.dp(23), 0);
        ...
        public void setTextAndIcon(CharSequence text, int icon) {
            ...
            if (icon != 0) {
                ...
                textView.setPadding(LocaleController.isRTL ? 0 : DisplayUtility.dp(56), 0, LocaleController.isRTL ? DisplayUtility.dp(56) : 0, 0);
            } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                if (progressViewStyle == 3) {
                    progressViewContainer.measure(MeasureSpec.makeMeasureSpec(DisplayUtility.dp(86), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(DisplayUtility.dp(86), MeasureSpec.EXACTLY));
                    ...
                    int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(availableWidth - DisplayUtility.dp(48), MeasureSpec.EXACTLY);
                    ...
                    if (buttonsLayout != null) {
                        ...
                        for (int a = 0; a < count; a++) {
                            ...
                            if (child instanceof TextView) {
                                ...
                                button.setMaxWidth(DisplayUtility.dp((availableWidth - DisplayUtility.dp(24)) / 2));
                            }
                        }
                    ...
                    if (titleTextView != null) {
                        if (secondTitleTextView != null) {
                            titleTextView.measure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(childWidthMeasureSpec) - secondTitleTextView.getMeasuredWidth() - DisplayUtility.dp(8), MeasureSpec.EXACTLY), heightMeasureSpec);
                        } else {
                    ...
                    if (progressViewStyle == 0) {
                        ...
                        if (customView != null) {
                            layoutParams.topMargin = titleTextView == null && messageTextView.getVisibility() == GONE && items == null ? DisplayUtility.dp(16) : 0;
                            layoutParams.bottomMargin = buttonsLayout == null ? DisplayUtility.dp(8) : 0;
                        } else if (items != null) {
                            layoutParams.topMargin = titleTextView == null && messageTextView.getVisibility() == GONE ? DisplayUtility.dp(8) : 0;
                            layoutParams.bottomMargin = DisplayUtility.dp(8);
                        } else if (messageTextView.getVisibility() == VISIBLE) {
                            layoutParams.topMargin = titleTextView == null ? DisplayUtility.dp(19) : 0;
                            layoutParams.bottomMargin = DisplayUtility.dp(20);
                        }
                        ...
                        if (lineProgressView != null) {
                            lineProgressView.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(DisplayUtility.dp(4), MeasureSpec.EXACTLY));
                    ...
                    if (lastScreenWidth != DisplayUtility.displaySize.x) {
                        Queues.runOnUIThread(() -> {
                            lastScreenWidth = DisplayUtility.displaySize.x;
                            final int calculatedWidth = DisplayUtility.displaySize.x - DisplayUtility.dp(56);
                            int maxWidth;
                            if (DisplayUtility.isTablet()) {
                                if (DisplayUtility.isSmallTablet()) {
                                    maxWidth = DisplayUtility.dp(446);
                                } else {
                                    maxWidth = DisplayUtility.dp(496);
                                }
                            } else {
                                maxWidth = DisplayUtility.dp(356);
                            }
        ...
        if (progressViewStyle == 0) {
            ...
            contentScrollView = new ScrollView(getContext()) {
                ...
                protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
                    ...
                    if (shadow[0].getPaint().getAlpha() != 0) {
                        shadow[0].setBounds(0, getScrollY(), getMeasuredWidth(), getScrollY() + DisplayUtility.dp(3));
                        shadow[0].draw(canvas);
                    }
                    if (shadow[1].getPaint().getAlpha() != 0) {
                        shadow[1].setBounds(0, getScrollY() + getMeasuredHeight() - DisplayUtility.dp(3), getMeasuredWidth(), getScrollY() + getMeasuredHeight());
            ...
            DisplayUtility.setScrollViewEdgeEffectColor(contentScrollView, getThemeColor(Theme.key_dialogScrollGlow));
        ...
        messageTextView.setMovementMethod(new DisplayUtility.LinkMovementMethodMy());
        ...
        if (progressViewStyle == 1) {
            ...
            lineProgressViewPercent.setTypeface(TypefaceUtility.getTypeface("fonts/rmedium.ttf"));
            ...
            progressViewContainer = new FrameLayout(getContext());
            progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(DisplayUtility.dp(18), Theme.getColor(Theme.key_dialog_inlineProgressBackground)));
        ...
        if (hasButtons) {
                            ...
                            if (tag == Dialog.BUTTON_POSITIVE) {
                                ...
                                if (LocaleController.isRTL) {
                                    ...
                                    if (positiveButton != null) {
                                        x += positiveButton.getMeasuredWidth() + DisplayUtility.dp(8);
                                    }
            ...
            buttonsLayout.setPadding(DisplayUtility.dp(8), DisplayUtility.dp(8), DisplayUtility.dp(8), DisplayUtility.dp(8));
...
//                textView.setSingleLine(true); //TODO
                ...
                textView.setPadding(DisplayUtility.dp(10), 0, DisplayUtility.dp(10), 0);
        ...
        if (progressViewStyle == 3) {
            ...
            lastScreenWidth = DisplayUtility.displaySize.x;
            final int calculatedWidth = DisplayUtility.displaySize.x - DisplayUtility.dp(48);
            int maxWidth;
            if (DisplayUtility.isTablet()) {
                if (DisplayUtility.isSmallTablet()) {
                    maxWidth = DisplayUtility.dp(446);
    ...
    public void dismiss() {
        ...
        Queues.cancelRunOnUIThread(showRunnable);
    }
    ...
    public void showDelayed(long delay) {
        Queues.cancelRunOnUIThread(showRunnable);
        Queues.runOnUIThread(showRunnable, delay);
    }

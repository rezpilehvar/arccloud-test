...
public final class FloatingToolbar {
    ...
    private final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            mMarginHorizontal = DisplayUtility.dp(16);
            mMarginVertical = DisplayUtility.dp(8);
            mLineHeight = DisplayUtility.dp(48);
            mIconTextSpacing = DisplayUtility.dp(8);
        ...
        private int getAdjustedToolbarWidth(int suggestedWidth) {
            ...
            refreshViewPort();
            int maximumWidth = mViewPortOnScreen.width() - 2 * DisplayUtility.dp(16);
            if (width <= 0) {
                width = DisplayUtility.dp(400);
            }
        ...
        private ImageButton createOverflowButton() {
            ...
            overflowButton.setLayoutParams(new ViewGroup.LayoutParams(DisplayUtility.dp(56), DisplayUtility.dp(48)));
            overflowButton.setPaddingRelative(DisplayUtility.dp(16), DisplayUtility.dp(12), DisplayUtility.dp(16), DisplayUtility.dp(12));
            ...
            OverflowPanel(FloatingToolbarPopup popup) {
                ...
                setOutlineProvider(new ViewOutlineProvider() {
                    ...
                    public void getOutline(View view, Outline outline) {
                        outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), DisplayUtility.dp(6));
                    }
                });
        ...
        private final class OverflowPanelViewHelper {
            ...
            public OverflowPanelViewHelper(Context context, int iconTextSpacing) {
                ...
                mSidePadding = DisplayUtility.dp(18);
    ...
    private View createMenuItemButton(Context context, MenuItem menuItem, int iconTextSpacing) {
        ...
        menuItemButton.setMinimumWidth(DisplayUtility.dp(48));
        menuItemButton.setMinimumHeight(DisplayUtility.dp(48));
        menuItemButton.setPaddingRelative(DisplayUtility.dp(16), 0, DisplayUtility.dp(16), 0);
        ...
        textView.setPaddingRelative(DisplayUtility.dp(11), 0, 0, 0);
        menuItemButton.addView(textView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, DisplayUtility.dp(48)));
        if (menuItem != null) {
    ...
    private ViewGroup createContentContainer(Context context) {
        ...
        layoutParams.bottomMargin = layoutParams.leftMargin = layoutParams.topMargin = layoutParams.rightMargin = DisplayUtility.dp(20);
        contentContainer.setLayoutParams(layoutParams);
        contentContainer.setElevation(DisplayUtility.dp(2));
        contentContainer.setFocusable(true);
        contentContainer.setFocusableInTouchMode(true);
        GradientDrawable shape = new GradientDrawable();
        shape.setShape(GradientDrawable.RECTANGLE);
        int r = DisplayUtility.dp(6);

...
public class BackDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawLine(-DisplayUtility.dp(7) - DisplayUtility.dp(1) * rotation, 0, DisplayUtility.dp(8), 0, paint);
        float startYDiff = -DisplayUtility.dp(0.5f);
        float endYDiff = DisplayUtility.dp(7) + DisplayUtility.dp(1) * rotation;
        float startXDiff = -DisplayUtility.dp(7.0f) + DisplayUtility.dp(7.0f) * rotation;
        float endXDiff = DisplayUtility.dp(0.5f) - DisplayUtility.dp(0.5f) * rotation;
